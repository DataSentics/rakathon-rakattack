...
SAMPLE_RESPONSE = {
    "modul_a_pacient_parametry": {
        ...
        "relevantni_komorbidity_a_stav_pacienta": {
            "zavazne_onemocneni_srdce_a_cev": ["hypertenze"],
            "onemocneni_funkcni_stav_komentar": "null",
            "zavazne_metabolicke_onemocneni": ["žádné"],
            "zavazne_plicni_onemocneni": ["žádné"],
            "zavazne_onemocneni_git": "NE",
            "zavazne_onemocneni_ledvin": ["žádné"],
            ...
            "zavazne_onemocneni_infeccni": ["žádné"],
    ...
    "modul_b_cast_b1": {
        ...
        "klasifikace_nadoru": {
            ...
            "diagnosticka_modalita": ["histologie primárního nádoru"],
